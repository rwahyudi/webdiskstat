...
button:focus-visible, .row:focus-visible, .tile:focus-visible, .top-file-row:focus-visible {{
...
.content.home {{
  grid-template-rows: minmax(180px, 36%) minmax(300px, 1fr);
}}
.treemap-frame {{
  min-width: 0;
  min-height: 0;
...
@media (max-width: 820px) {{
  ...
  .content.home {{
    grid-template-rows: minmax(210px, 34vh) minmax(320px, 1fr);
  }}
  .details {{
    grid-template-columns: 1fr;
  }}
